...
object PlaySupport {
  ...
  private val playPluginSbtContents = """|// Note: This file is autogenerated by Builder.  Please do not modify!
                                         |addSbtPlugin("com.typesafe.builder" % "sbt-shim-play" % """".stripMargin + APP_VERSION + "\")\n"
