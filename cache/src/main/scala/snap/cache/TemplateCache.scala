  ...
  override val metadata: Set[TemplateMetadata] =
    Set(
      ...
      TemplateMetadata(
        ...
        name = "Reactive Stock Tweets",
        version = "1.0",
        description = """The Reactive Stock Tweets application uses Java, Scala, Play Framework, and Akka to illustrate how to build reactive apps.  The tutorial in this example will teach you the reactive basics including Reactive Composition and Reactive Push.""",
