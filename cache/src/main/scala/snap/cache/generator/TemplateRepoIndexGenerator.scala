...
object TemplateRepoIndexGenerator {
  ...
  def makeCachePropertiesFile(zipHash: String, propsFile: File): File = {
    val props = new java.util.Properties
    props.setProperty(Constants.CACHE_HASH_PROPERTY, zipHash)
    Using.fileOutputStream(false)(propsFile) { out =>
      props.store(out, "Autogenerated by index creator.")
    }
    propsFile
  }
